...
export const times: [number, Times, Times][] = [
...
export function addTime(angle: number, riseName: Times, setName: Times) {
...
type TimesResult = Record<Times, Date>
...
export function getTimes(date: Date, lat: number, lng: number, height = 0) {
	...
	const result: Partial<TimesResult> = {
